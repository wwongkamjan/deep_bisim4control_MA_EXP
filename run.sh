...
srun bash -c "hostname; python train.py --eval_resource_files 'distractors/images/*.mp4' --resource_files 'distractors/images/*.mp4' --domain_name cheetah --task_name run --encoder_type pixel --decoder_type identity --action_repeat 4 --save_video --save_tb --work_dir ./log --seed 1"
