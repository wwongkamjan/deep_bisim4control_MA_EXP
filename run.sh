...
srun bash -c "hostname;  python train.py --img_source video --eval_resource_files './distractors/images/drivingcar1.mp4' --resource_files './distractors/images/drivingcar1.mp4' --total_frames 1000 --domain_name cheetah --task_name run --encoder_type pixel --decoder_type identity --action_repeat 4 --save_video --save_tb --work_dir ./log --seed 2"
